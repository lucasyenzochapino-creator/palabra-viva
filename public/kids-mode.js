(() => {
  ...
  function css(){
    if(document.getElementById('pv-kids-style-v6'))return;
    ...
    const st=document.createElement('style');st.id='pv-kids-style-v6';st.textContent=`
